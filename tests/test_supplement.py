...
def test_hemisphere_geometry():
    ...
    assert np.isclose(Hemisphere1.volume_to_height(1 / 3 * np.pi * 3 ** 3), 3 * (1 - 2*np.cos(4*np.pi/9)), atol=1e-10, rtol=1e-12)
...
def test_hemisphere_filling():
    ...
    assert np.isclose(Hemisphere1.filled_height, 3 * (1 - 2*np.cos(4*np.pi/9)), atol=1e-10, rtol=1e-12)

    assert np.isclose(Hemisphere1.filled_centroid, 0.698077340960644, atol=1e-10, rtol=1e-12)
