...
def test_add_trapezoidal_fins_sweep_angle(
    ...
    _ = rocket.add_nose(length=0.55829, kind="vonKarman", position=1.278)
    ...
    cpz = -1.182 - fin_set.cpz  # Should be - 1.232
