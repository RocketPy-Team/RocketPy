...
#         2, span=0.100, rootChord=0.120, tipChord=0.040, distanceToCM=-1.04956, airfoil=('data\airfoils\NACA0012-radians.txt','radians')
#     )
#     FinSetE473 = test_rocket.addFins(
#         2, span=0.100, rootChord=0.120, tipChord=0.040, distanceToCM=-1.04956, airfoil=('data\airfoils\e473-10e6-degrees.csv','degrees')
#     )
#     Tail = test_rocket.addTail(
#         topRadius=0.0635, bottomRadius=0.0435, length=0.060, distanceToCM=-1.194656
#     )
