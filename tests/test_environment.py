...
def test_env_set_date(example_env):
    ...
    assert example_env.date == datetime.datetime(tomorrow.year, tomorrow.month, tomorrow.day, 12)
...
def test_set_topographic_profile(example_env):
    ...
    assert example_env.getElevationFromTopograghicProfile(example_env.lat, example_env.lon) == 1565
