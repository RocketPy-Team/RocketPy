...
Env23.setAtmosphericModel(
    type="Reanalysis",
    file="tests/fixtures/motor/acceptance/NDRT_2020/env_23.nc",
    dictionary="ECMWF",
)
...
# Motor Information
L1395 = SolidMotor(
    thrustSource="tests/fixtures/motor/acceptance/NDRT_2020/Cesaroni_4895L1395-P.eng",
...
df_ndrt_raven = pd.read_csv(
    "tests/fixtures/motor/acceptance/NDRT_2020/fullscale_2-23_raven1_crop.csv"
)
