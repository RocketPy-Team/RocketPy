...
Env.setAtmosphericModel(
    type="Ensemble",
    file="tests/fixtures/motor/acceptance/PJ_Valetudo/LASC2019_byGio_in2020.nc",
    dictionary="ECMWF",
)
...
# Create motor
Keron = SolidMotor(
    thrustSource="tests/fixtures/motor/acceptance/PJ_Valetudo/thrustCurve.csv",
    burnOut=5.274,
    reshapeThrustCurve=(
...
Valetudo = Rocket(
    ...
    powerOffDrag="tests/fixtures/motor/acceptance/PJ_Valetudo/Cd_PowerOff.csv",
    powerOnDrag="tests/fixtures/motor/acceptance/PJ_Valetudo/Cd_PowerOn.csv",
)
