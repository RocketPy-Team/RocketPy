...
% rocketpy.Environment(rail_length, latitude, longitude, elevation);
...
Calisto = rocketpy.Rocket(pyargs( ...
    ...
    'coordinate_system_orientation', "nozzleToCombustionChamber", ...
));
...
nosecone = rocketpy.Rocket.add_nose(pyargs( ...
    'self', Calisto, ...
    'length', 0.55829, ...
    'kind', "vonKarman", ...
    'position', 1.278 ...
...
finset = rocketpy.Rocket.add_trapezoidal_fins(pyargs( ...
    'self', Calisto, ...
    'n', int32(4), ...
    'span', 0.100, ...
    'root_chord', 0.120, ...
...
tail = rocketpy.Rocket.add_tail(pyargs( ...
    'self', Calisto, ...
    'top_radius', 0.0635, ...
...
% py.help(rocketpy.Rocket.add_parachute)
%% 
...
Main = rocketpy.Rocket.add_parachute(pyargs( ...
    'self', Calisto, ...
    'name', "Main", ...
    'CdS', 10.0, ...
...
Drogue = rocketpy.Rocket.add_parachute(pyargs( ...
    'self', Calisto, ...
    'name', "Drogue", ...
    'CdS', 1.0, ...
