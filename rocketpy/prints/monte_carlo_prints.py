...
class _MonteCarloPrints:
    ...
    def all(self):
        ...
        print("Results: \n")
        print(f"{'Parameter':>25} {'Mean':>15} {'Median':>15} {'Std. Dev.':>15} {'95% PI Lower':>15} {'95% PI Upper':>15}")
        print("-" * 90)
        for key, value in self.monte_carlo.processed_results.items():
            try:
                print(f"{key:>25} {value[0]:>15.3f} {value[1]:>15.3f} {value[2]:>15.3f} {value[3]:>15.3f} {value[4]:>15.3f}")
            except TypeError:
