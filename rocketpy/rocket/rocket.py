        ...
        if positional_parameter_count == 1 and not accepts_var_args:
            ...
            def controller_wrapper(context):
                ...
                pos_args = [
                    ...
                    # The controller's live controlled objects rather than
                    # the captured ``air_brakes``: after a flight is loaded
                    # from a file the two differ, and only the former is the
                    # air brakes the rocket actually uses for drag.
                    context["controlled_objects"],
                    context["sensors"],
                    context["environment"],
                ]
                if accepts_var_args:
