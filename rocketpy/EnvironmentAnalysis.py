...
class EnvironmentAnalysis:
    ...
    def allInfo(self):
        ...
        print(f"Global Maximum wind gust: {self.maximum_wind_gust} {self.unit_system['wind_speed']}")
        print(f"Average maximum wind gust: {self.average_max_wind_gust} {self.unit_system['wind_speed']}")
        print("Temeprature Information")
        print(f"Global Maximum temperature: {self.record_max_temperature} {self.unit_system['temperature']}")
        print(f"Global Minimum temperature: {self.record_min_temperature} {self.unit_system['temperature']}")
        print(f"Average minimum temperture: {self.average_min_temperature} {self.unit_system['temperature']}")
        print(f"Average maximum temperature: {self.average_max_temperature} {self.unit_system['temperature']}")
