...
class _MotorPlots:
    ...
    def I_11(self, lower_limit=None, upper_limit=None, filename=None):
        ...
        None
        """
        self.motor.I_11.plot(lower=lower_limit, upper=upper_limit, filename=filename)

    def I_22(self, lower_limit=None, upper_limit=None, filename=None):
        ...
        None
        """
        self.motor.I_22.plot(lower=lower_limit, upper=upper_limit, filename=filename)

    def I_33(self, lower_limit=None, upper_limit=None, filename=None):
        ...
        None
        """
        self.motor.I_33.plot(lower=lower_limit, upper=upper_limit, filename=filename)

    def I_12(self, lower_limit=None, upper_limit=None, filename=None):
        ...
        None
        """
        self.motor.I_12.plot(lower=lower_limit, upper=upper_limit, filename=filename)

    def I_13(self, lower_limit=None, upper_limit=None, filename=None):
        ...
        None
        """
        self.motor.I_13.plot(lower=lower_limit, upper=upper_limit, filename=filename)

    def I_23(self, lower_limit=None, upper_limit=None, filename=None):
        ...
        None
        """
        self.motor.I_23.plot(lower=lower_limit, upper=upper_limit, filename=filename)
